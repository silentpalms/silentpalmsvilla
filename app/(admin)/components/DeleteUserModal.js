...
const DeleteUserModal = ({ hideModal, openModal, userId }) => {
    ...
    <>
      ...
      >
        <div className={`${poppins.className}`}>
          ...
          <p className={`text-[16px]`}>The user will be permanently deleted</p>
          ...
          <div className="mb-6">
            <div className="flex flex-col space-y-1">
              <label className="text-[16px]">
                Enter <span className="font-bold italic">delete-user</span>{" "}
                below to confirm
              </label>
              <input
                type="text"
