...
const DeleteBookingModal = ({ hideModal, showModal, openModal, bookingId, }) => {
  ...
  const handleChange = (e) => {
    ...
    if (confirmInput === "delete-booking") {
    ...
    <>
      ...
      >
        <div className={`${poppins.className}`}>
          ...
          <p className={`text-[16px]`}>This Booking will be deleted</p>
          ...
          <div className="mb-6">
            <div className="flex flex-col space-y-1">
              <label className="text-[16px]">
                Enter <span className="font-bold italic">delete-booking</span>{" "}
                below to confirm
              </label>
              <input
                type="text"
